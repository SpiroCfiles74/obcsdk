...
func main() {
	...
	chco2.CurrentTestName = "CAT_108_S0_IQDQIQ_R0_IQIQ_repeats.go"
...
chco2.Writer = bufio.NewWriter(osFile)
	...
	for i:=1; i <= numCycles; i++ {
		...
		// Extend 02 by: Restart VP0. Invoke. Query for consensus match (not all, not exact expected).
