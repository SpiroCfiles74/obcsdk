...
//package main // Use this to test individual programs
...
func deployChaincode(done chan bool) {
	...
	// var args = []string{argA[0], "Initial String here ...", argB[0], "0"}
	var args = []string{"Initial String here ...", "0"}
